<script lang="ts">
	...
	import { accountStakingConfigStore, calcMiningPower, calcTotals } from '../domain/staking';
	...
	$: {
		collectionsStaking = calcMiningPower($accountStakingConfigStore, $poolsStakingConfigStore);
